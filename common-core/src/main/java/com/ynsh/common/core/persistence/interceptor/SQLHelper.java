package com.ynsh.common.core.persistence.interceptor;

import com.ynsh.common.config.Global;
import com.ynsh.common.core.persistence.Page;
import com.ynsh.common.core.persistence.dialect.Dialect;
...
//	        countSql = "select count(1) " + removeSelect(removeOrders(tempSql));
		}
